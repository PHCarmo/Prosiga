...
ALTER TABLE disciplinas ADD CONSTRAINT disciplinas_pk PRIMARY KEY ( id_disciplina );
...
ALTER TABLE professores ADD CONSTRAINT professores_pk PRIMARY KEY ( id_professor );
...
ALTER TABLE turmas ADD CONSTRAINT turmas_pk PRIMARY KEY ( id_turma );
